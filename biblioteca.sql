...
CREATE TABLE libros (id SERIAL PRIMARY KEY, titulo VARCHAR(150) NOT NULL);
...
CREATE TABLE prestamo(id SERIAL PRIMARY KEY, id_libro INT, id_lector INT, fecha_inicio DATE, fecha_termino DATE, FOREIGN KEY (id_libro) REFERENCES libros(id), FOREIGN KEY (id_lector) REFERENCES lectores(id));
